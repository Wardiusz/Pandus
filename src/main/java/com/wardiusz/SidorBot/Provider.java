...
import com.wardiusz.SidorBot.commands.autocmd.*;
import com.wardiusz.SidorBot.Handler.Config;
import com.wardiusz.SidorBot.commands.prefix.EchoCmd;
import com.wardiusz.SidorBot.Handler.HelpCmd;
...
import com.wardiusz.SidorBot.Handler.Slash.SlashCommands;
...
import com.wardiusz.SidorBot.commands.prefix.ShutdownCmd;
import com.wardiusz.SidorBot.commands.slash.administrative.*;
import com.wardiusz.SidorBot.commands.slash.music.*;
import com.wardiusz.SidorBot.commands.slash.music.handlers.VCModule;
import com.wardiusz.SidorBot.commands.slash.other.PingCmd;
import com.wardiusz.SidorBot.commands.slash.administrative.SetGoodbyeMsgCmd;
import com.wardiusz.SidorBot.commands.slash.administrative.SetWelcomeMsgCmd;
...
public class Provider {
    ...
    public JDA buildJDA() throws InterruptedException {
        ...
        logger.info("{}\u001B[7m Loading SidorBot ver1.0.0 \u001B[0m{}", "-".repeat(30), "-".repeat(30));
